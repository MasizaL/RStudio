...
plot(vario.ext)
lines.variomodel(cov.m = "exp", cov.p = c(105, 36), nug = 6.9,
...
krige=krige.control(cov.model="exponential",cov.pars=c(105, 36),
...
krige=krige.control(cov.model="exponential",cov.pars=c(16000,47),
kappa=1,nugget=6.9,lambda=0.5))
kct2<- krige.conv(sic.100, loc = sic.367$coords,
krige=krige.control(cov.model="exponential",cov.pars=c(160,47),
kappa=1,nugget=6.9,lambda=0.5))
